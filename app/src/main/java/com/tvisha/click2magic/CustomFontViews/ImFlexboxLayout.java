...
public class ImFlexboxLayout extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (viewPartMainLineCount > 0 && !(viewPartMainLastLineWitdh + viewPartSlaveWidth >= viewPartMain.getMeasuredWidth())) {
    ...
    public void setNewOption(boolean b) {
        width_option = b;
