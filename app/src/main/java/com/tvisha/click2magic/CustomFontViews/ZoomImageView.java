  ...
  /*  public final float getImageScaleX() {
   ...
   /* public final float getImageTranslateY() {
    ...
    protected void onImageMatrixUpdated(Matrix imageMatrix) {
        ...
        float angle = 0,scaleX=0,scaleY=0,transX=0,transY=0;
        if (angle != imageAngle) {
            imageAngle = angle;
            onImageRotate(angle);
        }
...
/*
    ...
    private void setZoom(ZoomImageView img) {
  ...
  /*  public void setZoom(TouchImageView img) {
    ...
    public float getImageWidth() {
        if (matchViewWidth==(matchViewWidth * normalizedScale))
        {

            /*ImageviewActivity activity = new ImageviewActivity();
            activity.setIsZoom(false);*/
            setIsZoom(false);
        }else {

            /*ImageviewActivity activity = new ImageviewActivity();
            activity.setIsZoom(true);*/
            setIsZoom(true);
        }
        return matchViewWidth * normalizedScale;
    }

    public boolean setIsZoom(boolean b) {
        is_zoom = b;
        //this.getIsZoom();
        return b;
    }
